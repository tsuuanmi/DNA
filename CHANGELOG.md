...
- Production-oriented CI/CD and supply-chain verification, including strict cargo-shear dependency/source hygiene, pre-tag release-package smoke testing, and an explicit Ubuntu 24.04 runner baseline.
