...
- **SRS-VAL-004:** Rust source-policy validation, documentation-structure validation, format, check, Clippy warnings-denied, all tests, rustdoc, schema/example validation, TOML validation, docs mirror, and rCRS identity gates MUST pass.
