...
|---|---|---|---|---|
| [`SRS-IN-*`](srs/input.md) | [`methods/pipeline.md`](methods/pipeline.md), [`architecture/system.md`](architecture/system.md) | `src/trace/`, `src/reference/`, `src/cli/` | parser/reference/CLI tests, synthetic ABIF | CLI/config contracts |
...
| [`SRS-COMPAT-*`](srs/quality-validation.md) | [`governance/reference-validation.md`](governance/reference-validation.md) | cross-cutting | approved differential evidence | reference-validation policy |
| [`SRS-NFR-*`](srs/quality-validation.md) | [`architecture/invariants.md`](architecture/invariants/README.md), validation | cross-cutting | CI, fuzz/property/release evidence as adopted | release evidence |
