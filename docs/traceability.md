...
| [`SRS-NFR-*`](srs/quality-validation.md) | [`architecture/invariants/`](architecture/invariants/README.md), validation | cross-cutting | CI, fuzz/property/release evidence as adopted | release evidence |
