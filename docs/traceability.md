...
| [`SRS-NFR-*`](srs/quality-validation.md) | [`architecture/invariants.md`](architecture/invariants.md), validation | cross-cutting | CI, fuzz/property/release evidence as adopted | release evidence |
