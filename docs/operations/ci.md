...
The documentation-structure gate enforces one `README.md` index per documentation folder except the exact `docs/src/**` source mirror, rejects duplicate `topic.md` + `topic/README.md` entry points, and rejects legacy/archive/history/temporary documentation directories.
